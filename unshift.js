/*
*  (  What does it do?  ) 1. Adds an element to the beginning of an array
* and adds one to the index of all other elements.
...
queueSize = serviceArray.unshift(newCall);
//When someone is serviced you can shift to shrink the queue
let temp = serviceArray.pop();
